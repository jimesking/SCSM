...
insert into analogSensor (name,address,description,aInterval,aFormat,aMd,aMu,h4l,h3l,h2l,h1l,l1l,l2l,l3l,l4l) 
values ('U2CSP001AM','admin.stationA.moduleA.2','模拟量1',60,'0.00',0,100,95,90,85,80,20,15,10,5);

insert into analogSensor (name,address,description,aInterval,aFormat,aMd,aMu,h4l,h3l,h2l,h1l,l1l,l2l,l3l,l4l) 
values ('U2CSP002AM','admin.stationA.moduleA.3','模拟量1',60,'0.00',0,100,95,90,85,80,20,15,10,5);
...
insert into digitalSnesor (name,address,description,aInterval) values ('U2CSP001DM','admin.stationA.moduleA.0','中文会乱码',60);
insert into digitalSnesor (name,address,description,aInterval) values ('U2CSP002DM','admin.stationA.moduleA.1','中文会乱码',60);
...
insert into logInfo(type,address,createTime,description) values (1,'U2CSP001DM',Now(),'abc');
insert into logInfo(type,address,createTime,description) values (2,'U2CSP001DM',Now(),'abcd');
